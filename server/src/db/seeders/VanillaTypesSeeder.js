...
class VanillaTypeSeeder {
    ...
    static getTypeIcon(typeName) {
        ...
        switch (typeName) {
            case 'normal':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Normal_icon_HOME3.png"
                break
            case 'fighting':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Fighting_icon_HOME3.png"
                break
            case 'flying':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Flying_icon_HOME3.png"
                break
            case 'poison':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Poison_icon_HOME3.png"
                break
            case 'ground':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Ground_icon_HOME3.png"
                break
            case 'rock':
            ...
            case 'grass':
                ...
                break
            case 'electric':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Electric_icon_HOME3.png"
                break
            case 'psychic':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Psychic_icon_HOME3.png"
                break
            case 'ice':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Ice_icon_HOME3.png"
                break
            case 'dragon':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/Dragon_icon_HOME3.png"
                break
            case 'dark':
                iconUrl = "https://romhack-studio-production.s3.amazonaws.com/63px-Dark_icon_HOME3.png"
                break
            case 'fairy':
